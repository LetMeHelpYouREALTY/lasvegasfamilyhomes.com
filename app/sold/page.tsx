...
import { SOLD_INVENTORY, getLpClonePage } from "@/lib/lp-clone";
import { agentInfo, siteConfig } from "@/lib/site-config";

const page = getLpClonePage("/sold")!;
    ...
    <LpPageChrome>
      ...
      <div className="mx-auto max-w-6xl px-4">
        <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-blue-700">
          {SOLD_INVENTORY.kicker}
        </p>
        <h1 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">
          {page.h1}
        </h1>
        <p className="mb-8 max-w-3xl text-lg text-slate-600">
          {SOLD_INVENTORY.intro}
        </p>
      </div>
      <InventoryExperience config={SOLD_INVENTORY} includeHeading={false} />
    </LpPageChrome>
  );
}
