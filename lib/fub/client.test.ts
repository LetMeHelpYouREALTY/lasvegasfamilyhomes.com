...
// Skipped: tests target a singleton `fubClient.createLead` API that this
// module does not export (class is `FollowUpBossClient` with upsertPerson).
describe.skip("FUB Client", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
